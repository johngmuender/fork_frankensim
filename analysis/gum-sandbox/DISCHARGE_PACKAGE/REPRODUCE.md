...
| K1 convention null | `python3 analysis/gum-sandbox/theory-audit/k1_discriminator.py` | 2 s | 17/17; every channel < 2σ; verified null |
| K2 small-ε probe | `python3 analysis/gum-sandbox/theory-audit/k2_smalleps.py` | 180 s cold / 2 s resumed | 11/12 (the FAIL is finding K2-D1); linear to ε = 0.001 |
