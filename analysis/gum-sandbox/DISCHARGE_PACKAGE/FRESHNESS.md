...
|---|---|---|---|---|---|---|---|
| K01 | 1 | `tier0-gauntlet/` → `cargo run --release` | 52/52; root e19d0bcb… | 0.3 s | — | — | PENDING |
| K02 | 1 | `tier4-field/fs-cosserat-pilot/` → `cargo run --release` | 13/13; root f88731af… | ~0.2 s | — | — | PENDING |
| K03 | 1 | `gum-core/fs-gum-field/` → `cargo build --release && ./target/release/gum_field_gates` | 25/25; root 6c1e7850…; fp 7c9931a5… | 1.7 s | — | — | PENDING |
...
| K05 | 1 | `gum-core/fs-gum-topo/` → `cargo run --release --bin gates` | 25/25; root 9cfbe9a6… | ~5 s | — | — | PENDING |
| K06 | 1 | `gum-core/fs-gum-cosserat/` → `cargo run --release` | 20/20 + 26/26 PASS | 2.9 s | — | — | PENDING |
| K07 | 1 | `gum-core/fs-gum-cosserat/` → `cargo test --release` | 5/5 | — | — | n/a | PENDING |
...
| K10 | 2 | rows 2–3 ("same run") | covered by K09 | — | — | — | PENDING |
| K11 | 2 | `cd analysis/gum-sandbox/tier4-field/fs-cosserat-pilot && cargo run --release` | certified SDiff + ¼ claims; root f88731af… | ~0.2 s | — | — | PENDING |
...
| K13 | 2 | two-line proof (`axi_FR4_NOTE.md`) | analytic — read | — | — | n/a | PENDING |
...
| K18 | 3 | `python3 radial_solve.py` (tier2-closure; unit-map row) | tail mass μ²=m̃²/(2a_ψ) to 2×10⁻⁶ | ~1 s | — | — | PENDING |
| K19 | 4 | `tier0-gauntlet/` → `cargo run --release` (repeat) | 52/52 | 0.3 s | — | — | PENDING |
| K20 | 4 | `tier1-spectrum/` → `python3 spectrum.py` | four-branch spectrum; factor 4 = 4.000000000 | 5.8 s | — | — | PENDING |
| K21 | 4 | `tier2-closure/` → `python3 closure_reduced.py` | ε→0 endpoint to 6 decimals; ¼ automatic | seconds | — | — | PENDING |
| K22 | 4 | `tier2-closure/` → `python3 radial_solve.py` | App. I.1 gates; Derrick 6×10⁻⁷ | ~1 s | — | — | PENDING |
...
| K25 | 4 | `tier5-family/` → `python3 family_audit.py` | quark belt; ΔN_eff = 0.026772 | seconds | — | — | PENDING |
...
| K30 | v2 | `python3 analysis/gum-sandbox/theory-audit/h24_helical.py` | 0.332ƛ² / 0.568ƛ²; premises verified | <1 s | — | n/a | PENDING |
| K31 | v2 | `python3 analysis/gum-sandbox/theory-audit/h25_sdw.py` | 𝔞₁(p,q) formula; 27/27 | 3 s | — | n/a | PENDING |
...
| K34 | v2 | `python3 analysis/gum-sandbox/theory-audit/t3_closures.py` | 𝔠 = 64√2/9π; six 2.5147 routes fail | <1 min | — | n/a | PENDING |
| K35 | v2 | `python3 analysis/gum-sandbox/tier2-closure/gstar_solve.py` | G* → 16√2/9 (Richardson 6.0e-7) | 31 s | — | n/a | PENDING |
...
| K37 | v2.2 | `python3 analysis/gum-sandbox/theory-audit/h4_compute.py` | ±2·[rot]; winding −2.000000; 28/28 | 9 s | — | n/a | PENDING |
| K38 | v2.2 | `python3 analysis/gum-sandbox/theory-audit/i1_r5test.py` | 3.2011 at +0.51σ; ≈7σ separation | 757 s | — | n/a | PENDING |
| K39 | v2.2 | `python3 analysis/gum-sandbox/theory-audit/i2_propagate.py` | 34/34; κ²g_tot = 35/24; 13.4σ | 2 s | — | n/a | PENDING |
| K40 | v2.2 | `python3 analysis/gum-sandbox/theory-audit/i3_conventions.py` | 𝔭 and 𝔟_eff jointly resolved | 1 s | — | n/a | PENDING |
| K41 | v2.2 | `python3 analysis/gum-sandbox/theory-audit/i4_compute.py` | σ(exchange) = −1; 2/8 sectors; 19/19 | 4 s | — | n/a | PENDING |
